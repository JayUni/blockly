...
Blockly.Skoolbot['digitalread'] = function(block) {
  ...
  var code = '{ \"block_name\": \"io_statement_dread\",  \"arguments\": [ { \"block_name\": \"variables_statement_get\", \"functionName\": \"variables_get\", \"varName\": \"' + variable_name + '\"}]}';
...
Blockly.Skoolbot['digitalwrite'] = function(block) {
  ...
  // TODO: Assemble Skoolbot into code variable.
  var code = '{ \"block_name\": \"io_statement_dwrite\", \"arguments\": [ { \"block_name\": \"variables_statement_get\", \"functionName\": \"variables_get\", \"varName\": \"'  + variable_var + '\"}, {\"value\": \"' +dropdown_name +  '\" }]}';
  return code;
};
...
Blockly.Skoolbot['analogread'] = function(block) {
  var variable_name = Blockly.Skoolbot.variableDB_.getName(block.getFieldValue('var'), Blockly.Variables.NAME_TYPE);
  // TODO: Assemble Skoolbot into code variable.
  var code = '{ \"block_name\": \"io_statement_aread\", \"arguments\": [ { \"block_name\": \"variables_statement_get\", \"functionName\": \"variables_get\", \"varName\": \"'  + variable_name + '\" }]}';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.Skoolbot.ORDER_ATOMIC];
};
...
Blockly.Skoolbot['analogwrite'] = function(block) {
  ...
  // TODO: Assemble Skoolbot into code variable.
  var code = '{ \"block_name\": \"io_statement_awrite\", \"arguments\": [ { \"block_name\": \"variables_statement_get\", \"functionName\": \"variables_get\", \"varName\": \"'  + variable_var + '\"}, { "block_name": "math_number_number", "number": ' +number_name + ' }]}';
  return code;
};
...
Blockly.Skoolbot['pinmode'] = function(block) {
  ...
  // TODO: Assemble Skoolbot into code variable.
  var code = '{ \"block_name\": \"io_statement_pinmode\", \"arguments\": [ { \"block_name\": \"variables_statement_get\", \"functionName\": \"variables_get\", \"varName\": \"'  + variable_var + '\"}, {\"pinmode\": \"' + dropdown_name + '\"}]}';
  return code;
